...
export const COLLECTIONS: readonly Collection[] = [
  {
    ...
    lede: 'Con el dato confirmado en cada ficha: estas herramientas no exigen introducir una tarjeta para usar su plan gratuito.',
    description:
      'Herramientas de IA con plan gratuito real que no piden tarjeta de crédito. Comprobado contra la página oficial, con fecha de comprobación.',
...
Aquí sólo aparecen las herramientas donde hemos **confirmado** que no hace falta tarjeta. Las que no hemos podido verificar no entran: un "no lo sé" no vale como garantía.`,
  ...
  },
  {
    ...
    description:
      'Herramientas de IA cuyo plan gratuito permite uso comercial del resultado. Con la licencia comprobada y la fecha de comprobación.',
...
A cambio necesitas hardware: para modelos de imagen y vídeo, una GPU con VRAM suficiente; para modelos de lenguaje, memoria. Cada ficha indica los requisitos concretos cuando los hemos comprobado.`,
  ...
  },
  {
    ...
    description:
      'Herramientas de IA open source, con la licencia comprobada. Su gratuidad no depende de una decisión comercial futura.',
...
Es la única categoría donde la palabra "gratis" no lleva asterisco.`,
  ...
  },
  {
    ...
    description:
      'Herramientas de IA cuyo plan gratuito entrega resultados sin marca de agua. Comprobado con fecha.',
...
Estas herramientas entregan el resultado limpio en su capa gratuita. Comprueba también la fila de uso comercial: no tener marca de agua y poder monetizar son dos permisos distintos, y no siempre vienen juntos.`,
  ...
  },
  {
    ...
    context: `Esta colección cruza tres condiciones: valor para quien crea contenido por su cuenta, capa gratuita utilizable de verdad y ausencia de las trampas que más estorban a quien entrega trabajo — marca de agua y restricción comercial.
...
No es una lista de "lo más popular": es lo que sobrevive a mirar la letra pequeña.`,
  ...
  },
  {
    ...
    description:
      'Herramientas de IA utilizables sin crear cuenta. Comprobado contra la página oficial.',
